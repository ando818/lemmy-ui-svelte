<script>
    ...
    import { instances} from '$lib/store.js'

	const fruits = [
		{ text: 'lemmy.world', value: 'lemmy.world' },
		{ text: 'lemmy.ml', value: 'lemmy.ml' },
		{ text: 'beehaw.org', value: 'beehaw.org' },
    ...
    let modal;
    let searchbar;
    let selectedFruitsText;
	onMount(() => {

	 list = document.querySelector('ion-list#modal-list');
	 modal = document.querySelector('ion-modal');
	 searchbar = document.querySelector('ion-searchbar');
	 selectedFruitsText = document.querySelector('#selected-fruits');
		...
		modal.addEventListener('ionChange', (ev) => {
            ...
            $instances = workingSelectedFruits
		});
	...
	<ion-header>
		<ion-toolbar>
			<ion-buttons slot="start">
				<ion-button on:click={cancelChanges}>Cancel</ion-button>
			</ion-buttons>
			<ion-title>Instances</ion-title>
			<ion-buttons slot="end">
				<ion-button on:click={confirmChanges}>Done</ion-button>
			</ion-buttons>
		</ion-toolbar>
		<ion-toolbar>
			<ion-searchbar />
